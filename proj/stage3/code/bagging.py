...
def baggingTest(X_train, X_test, y_train, y_test):
    print('-----------------------------')    
    ...
    for i in depths:
        ...
        clf = BaggingClassifier(base_estimator=DecisionTreeClassifier(max_depth=i))
    ...
    strFile = str(path)+"/output/bagging"+"/Test Accuracy.png"
